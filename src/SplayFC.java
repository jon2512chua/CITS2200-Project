...
public class SplayFC implements ISplayFC {
	...
	public SplayFC() { top = null; }
	public SplayFC(Cell c) { top = c; }
	...
	public Cell splay(Cell c, String k) {
		...
		if(compareToCKey<0 && c.lt!=null) {                         // Search left
			//This then compares to the left half child of c.
	...
	public boolean add(String k) { 
		if(top==null) { top = cell(k, null, null); return true; }
		Cell s = splay(top, k);
	...
	public boolean remove(String k) { throw new RuntimeException("remove: implementation incomplete"); }
	public boolean contains(String k) { throw new RuntimeException("contains: implementation incomplete"); }
	public SplayFC headSet(String k) { throw new RuntimeException("headSet: implementation incomplete"); }
	...
	public SplayFC clone() { throw new RuntimeException("clone: implementation incomplete"); }
	/*
	 * TODO: iterator must start at root
	 */
	public Iterator<String> snapShotIterator() { throw new RuntimeException("iterator: implementation incomplete"); }
	public Iterator<String> updatingIterator() { throw new RuntimeException("iterator: implementation incomplete"); }
  ...
  public class SnapShotIterator implements Iterator<String> {  	
  	...
  	public boolean hasNext() { throw new RuntimeException("hasNext: implementation incomplete"); }
		public String next() { throw new RuntimeException("next: implementation incomplete"); }
  ...
  public class UpdatingIterator implements Iterator<String> {  	
  	...
  	public boolean hasNext() { throw new RuntimeException("hasNext: implementation incomplete"); }
		public String next() { throw new RuntimeException("next: implementation incomplete"); }		
		public void remove(){ throw new RuntimeException("remove: implementation incomplete"); }			
	}
